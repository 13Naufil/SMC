...
<aside id="left-sidebar-nav">
    <ul id="slide-out" class="side-nav fixed leftside-navigation">
        <li class="user-details cyan darken-2">
            <div class="row">
                ...
                <div class="col col s8 m8 l8">
                    ...
                    <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">TFS<i class="mdi-navigation-arrow-drop-down right"></i></a>
        ...
        <li class="bold"><a href="#" class="waves-effect waves-cyan"><i class="fa fa-male"></i> Teachers</a>
        </li>
        <li class="no-padding">
            <ul class="collapsible collapsible-accordion">
                <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-account-circle"></i> User Management</a>
                    <div class="collapsible-body">
                        <ul>
                            <li><a href="css-typography.html">Users</a>
                            </li>
                            <li><a href="css-icons.html">Roles</a>
                            </li>
                            <li><a href="css-shadow.html">Module</a>
                            </li>
                        </ul>
                    </div>
                </li>
