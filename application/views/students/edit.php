    ...
    <div class="row">
      <div class="col s12 m12 l12">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url(); ?>Students/edit/<?php echo $id; ?>">Edit</a></li>
        </ol>
      </div>
    </div>
  </div>
...
<div class="container">
     ...
     <?php 
        ...
        echo form_open_multipart('Students/update', $attributes); 
            ...
            <div class="input-field col s6">
                ...
                echo form_hidden('id',$student->id);
                    $data = array(
                        ...
                        'class'         => 'validate',
                        'required'      => 'required',
                        'value'         => stripslashes($student->gr_num)
                    );
            ...
            <div class="input-field col s6">
                <?php
                    $data = array(
                        ...
                        'class'         => 'validate',
                        'required'      => 'required',
                        'value'         => stripslashes($student->name)
                    );
                    echo form_input($data);
                ?>
            ...
            <div class="input-field col s6">
                <?php
                    $data = array(
                        ...
                        'class'         => 'validate',
                        'required'      => 'required',
                        'value'         => stripslashes($student->father_name)
                    );
                    echo form_input($data);
                ?>
            ...
            <div class="input-field col s6">
                <?php
                    $data = array(
                        ...
                        'required'      => 'required',
                        'value'         => stripslashes($student->dob)
                    );
                    echo form_input($data);
                ?>
            ...
            <div class="input-field col s6">
                <?php
                    $data = array(
                        ...
                        'class'         => 'validate datepicker',
                        'required'      => 'required',
                        'value'         => stripslashes($student->doa)
                    );
                    echo form_input($data);
                ?>
            ...
            <div class="input-field col s4">
                <?php
                    $data = array(
                        ...
                        'class'         => 'validate',
                        'required'      => 'required',
                        'value'         => stripslashes($student->res_num)
                    );
                    echo form_input($data);
                ?>
            ...
            <div class="input-field col s4">
                <?php
                    $data = array(
                        ...
                        'class'         => 'validate',
                        'required'      => 'required',
                        'value'         => stripslashes($student->office_num)
                    );
                    echo form_input($data);
                ?>
            ...
            <div class="input-field col s4">
                <?php
                    $data = array(
                        ...
                        'class'         => 'validate',
                        'required'      => 'required',
                        'value'         => stripslashes($student->emergency_num)
                    );
                    echo form_input($data);
                ?>
            ...
            <div class="input-field col s6">
                <?php
                    $data = array(
                        ...
                        'row'           => '4',
                        'required'      => 'required',
                        'value'         => stripslashes($student->address)
                    );
